...
const (
	...
	UserService_ListAllUsers_FullMethodName = "/auth.UserService/ListAllUsers"
)
...
type UserServiceClient interface {
	...
	ListAllUsers(ctx context.Context, in *ListUserRequest, opts ...grpc.CallOption) (*ListUsersResponse, error)
}
...
func (c *userServiceClient) ListAllUsers(ctx context.Context, in *ListUserRequest, opts ...grpc.CallOption) (*ListUsersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	...
	ListAllUsers(context.Context, *ListUserRequest) (*ListUsersResponse, error)
...
func (UnimplementedUserServiceServer) ListAllUsers(context.Context, *ListUserRequest) (*ListUsersResponse, error) {
...
func _UserService_ListAllUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).ListAllUsers(ctx, req.(*ListUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "auth/models/user.proto",
}
